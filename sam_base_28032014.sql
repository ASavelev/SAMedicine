...
INSERT INTO `ActionPropertyType` VALUES (1,'Наследственная предрасположенность','TEXT',NULL),(2,'Семейный, близкородственный анамнез заболевания (в семье, из родственников псориазом болеют)','Constructor','1_01'),(3,'Социальный состав','Constructor','1_02'),(4,'Жилищно-бытовые условия','Constructor','1_03'),(5,'Профессиональные вредности','Constructor','1_04'),(6,'Смена профессии, места работы','Constructor','1_05'),(7,'Было ли причиной смена места работы, профессии заболевание псориазом','Constructor','1_06'),(8,'Сколько раз больной госпитализировался в дерматологический стационар','Constructor','1_07'),(9,'Год начала заболевания','TEXT',NULL),(10,'Месяц возникновения заболевания','Constructor','1_08'),(11,'Срок давности заболевания','Constructor','1_09'),(12,'Первые высыпания (локализация):','Constructor','1_10'),(13,'Предполагаемая причина со слов больного:','TEXT',NULL),(14,'Фокальная инфекция','Constructor','1_11'),(15,'Связь псориаза с другими дерматозами','Constructor','1_12'),(16,'Частота рецидивов','Constructor','1_13'),(17,'Сезонность рецидивовзаболевания','Constructor','1_14'),(18,'Причины рецидивов или факторы    провоцирующие возникновение рецидивов','TEXT',NULL),(19,'Год наступления последнего рецидива','TEXT',NULL),(20,'Месяц наступления последнего рецидива','Constructor','1_15'),(21,'Ремиссия:','Constructor','1_16'),(22,'Средняя продолжительность ремиссии:','Constructor','1_17'),(23,'Продолжительность последней ремиссии','Constructor','1_18'),(24,'Начало длительной ремиссии','TEXT',NULL),(25,'Окончание длительной ремиссии','TEXT',NULL),(26,'Обострение:','Constructor','1_19'),(27,'Локализация высыпаний на моментобследования','Constructor','1_20'),(28,'Указать длительность с момента появления  первых высыпаний до диссеминации  псориатического процесса (для больных с  псориатическим артритом - до появ','Constructor','1_21'),(29,'Субъективные признаки','Constructor','1_22'),(30,'Распространенность поражения кожи','Constructor','1_23'),(31,'Распространенность поражения кожи по характеру морфологических элементов','Constructor','1_24'),(32,'Поражения суставов:','Constructor','1_25'),(33,'Поражения слизистой оболочки:','Constructor','1_26'),(34,'Эффект от ранее проводимого лечения','Constructor','1_27'),(35,'Проведенная терапия в момент последнего обострения','TEXT',NULL),(36,'Площадь поражения: PASI','TEXT',NULL),(37,'Формы псориаза:','TEXT',NULL),(38,'Атипичные формы:','Constructor','1_28'),(39,'Тип псориаза:','Constructor','1_29'),(40,'Развернутый клинический диагноз','TEXT',NULL),(41,'Стадии заболевания:','Constructor','1_30'),(42,'Сопутствующие заболевания:','Constructor','1_31'),(43,'Аллергологический анамнез','Constructor','1_32'),(44,'Наличие псориатической триады','Constructor','1_33'),(45,'Феномен Кебнера','Constructor','1_34');
...
CREATE TABLE `rbPrice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Прайс';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rbPrice` VALUES (1,'031','Прием (осмотр, консультация) врача-терапевта первичный',0.5,1,441),(2,'032','Прием (осмотр, консультация) врача-офтальмолога первичный',0.5,1,882),(3,'033','Прием (осмотр, консультация) врача-эндокринолога первичный',0.5,1,1762),(4,'034','Прием (осмотр, консультация) врача-акушера-гинеколога первичный',0.25,1,2424);
...
-- Dump completed on 2014-03-28 16:55:26
